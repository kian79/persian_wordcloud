...
photo_path = input("where do you want to save the photo?enter absolute path.(just press enter and leave it blank to "
...
image.save(photo_path.strip()+'{time}_photo.png'.format(time=filename))
